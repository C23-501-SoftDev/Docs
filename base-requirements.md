...
* **Управление пространствами:** Создание и настройка пространств (Spaces), назначение ответственных редакторов и прав доступа для пользователей и групп на уровне всего пространства. Владельцем пространства может быть только пользователь с правами администратора (`is_admin = true`).
