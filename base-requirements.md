...
* Физическое удаление (Hard-delete) доступно только пользователям с `is_admin = true` или происходит автоматически по истечении заданного периода удержания (опционально для MVP).
