...
* При удалении документа, имеющего дочерние элементы, они автоматически переподчиняются родителю удаляемого документа.
* Администратор или Редактор (если есть права) может восстановить документ из "Корзины", вернув его в статус "Опубликован".
* При восстановлении документа, чей исходный родитель был удален, восстанавливаемый документ переподчиняется "дедушке" (родителю своего удаленного родителя).
