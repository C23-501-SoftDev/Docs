...
Основная таблица контента. Хранит текст документов в формате Wiki-разметки (Markdown) и управляет их жизненным циклом. Права доступа к документам определяются исключительно через права на уровне пространства и глобальную роль пользователя.
