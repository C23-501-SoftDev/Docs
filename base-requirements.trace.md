...
[
   ...
   - **Статус:** Покрыто
   - **Элементы бэклога:** [E1, F1.1, US1.1.2, US1.1.4, US1.1.7]
]
...
[
   ...
   - **Статус:** Покрыто
   - **Элементы бэклога:** [US1.1.2, US1.1.8]
]
...
[
   ...
   - **Статус:** Покрыто
   - **Элементы бэклога:** [US4.1.1, US1.1.1, US1.1.4]
]
...
[
   ...
   - **Статус:** Не покрыто
   - **Элементы бэклога:** []
   - **Комментарий:** В текущем бэклоге отсутствуют явные задачи на внедрение Swagger/OpenAPI.
]
...
5. **Работа с данными:**
    * Поддержка транзакционности (база данных + Git на сервере).
    [
       ...
       - **Комментарий:** В бэклоге есть задача на Git commit при сохранении, но явного требования обеспечения транзакционности между БД и Git нет.
    ]
...
7. **Логическая схема системы**:
    ...
    * Подробное описание компонентов, их взаимодействия и потоков данных приведено в документе: documents/logic_scheme.md
    [
       ...
       - **Статус:** Покрыто
       - **Элементы бэклога:** [US4.1.1, US1.1.4, US1.1.6, US2.2.5, US4.3.1]
    ]
